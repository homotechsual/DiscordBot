...
* Fix GitHub slash command interaction acknowledgement timeout

## [1.4.0] - 2026-09-05

### Added

* Add GitHub repository monitor for issues, pull requests, workflow runs, and releases with per-category runtime toggles and channel routing
